...
ifneq ($(HAVOC_DEV_CERTIFICATE),)
    PRODUCT_DEFAULT_DEV_CERTIFICATE := $(HAVOC_DEV_CERTIFICATE)
endif

ifneq ($(HAVOC_VERITY_CERTIFICATE),)
    PRODUCT_VERITY_SIGNING_KEY := $(HAVOC_VERITY_CERTIFICATE)
endif
